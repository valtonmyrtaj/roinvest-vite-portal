-- Migration: complete_unit_sale reservation mirror cleanup
-- Date: 2026-04-23
-- Purpose:
-- 1. Keep `unit_reservations` as reservation authority
-- 2. Clear the legacy `units.reservation_expires_at` mirror when a sale completes
-- 3. Prevent sold units from retaining stale reservation expiry values
